libname cheng "y:\liulei\collaboration\zheng cheng\paper2\data3";
%let datadir=y:\liulei\collaboration\zheng cheng\paper2\data3;
...
data _null_;
set result;
file "y:\liulei\collaboration\zheng cheng\paper2\data3\AGQresult3.txt";
...
%do ii=1 %to 200;
	data _null_;
	set cov&ii;
	file "y:\liulei\collaboration\zheng cheng\paper2\data3\cov&ii..txt";
