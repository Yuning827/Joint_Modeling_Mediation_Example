...
setwd("C:/Users/cheng.zheng/Desktop/Lei/data4")
...
true_effects=foreach (t=tlist,.combine=c)%do%{
	set.seed(1111)
	med4(qq,as.numeric(truepar),K=KK,M=MM*10,t,nr)
}
...
for (i in 1:200){
	tmp=read.csv(paste("boot_res4_i=",as.character(i),".csv",sep=""))
