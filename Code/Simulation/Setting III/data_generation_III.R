...
data.gen=function(beta.0, alpha.0, eta.0, gamma.0, delta.0, var.a.0, var.e.0, n.id, Lambda.0, p=1/2, J, par=NULL) #Lambda.0 is our assumed baseline hazard, par are parameters related to the baseline hazard
{
	...
	# Gamma distribution with shape 1.5 and scale 1
	# log Gamma distribution has a mean close to 0 and variance close to 1
	
	a=log(rgamma(n.id, shape=1.5, scale=1))
...
#	filedir.1="c:\\liulei\\collaboration\\Zheng Cheng\\paper2\\data5\\"
filedir.1 = "C:/Users/cheng.zheng/Desktop/Lei/data5/"
